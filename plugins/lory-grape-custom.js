                    ...
                    l = a(
                        {
                            ...
                            prevProps: {},
                            nextProps: {},
                            slideEls: '<div class="gjs-lory-slide"></div><div class="gjs-lory-slide"></div><div class="gjs-lory-slide"></div>',
                            prevEl:
                            ...
                            s.length ||
                                s.add(
                                    '<div data-gjs-type="' +
                                        ...
                                        '">' +
                                        t.slideEls +
                                        '</div>    </div>    <span data-gjs-type="' +
                                        c +
                                        '">' +
                                        t.prevEl +
                                        '</span>    <span data-gjs-type="' +
                                        f +
                                        '">' +
                                        t.nextEl +
                                        "</span>"
